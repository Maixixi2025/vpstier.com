...
// submission pointing at the canonical URL still works. If content grows
// beyond the integration's entryLimit (default 45k), this script still works —
// it just merges more chunks.
//
...
async function main() {
  ...
  // <urlset> at /sitemap.xml. Keeps lastmod per URL.
  const allLocs = [];
